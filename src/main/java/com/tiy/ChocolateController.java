...
public class ChocolateController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        System.out.println("ChocolateController.initialize()");

        GraphicsContext graphicsContext = chocolateCanvas.getGraphicsContext2D();
        System.out.println("GC: " + graphicsContext);
